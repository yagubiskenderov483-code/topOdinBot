...
5. Проверьте:
   ...
   - Telegram: `/start` у @FunPaySwopsRobot
6. **BotFather** → @FunPaySwopsRobot → Configure Mini App → домен:
...
Ссылки на сделки: `https://t.me/FunPaySwopsRobot?start=deal_FPxxxxx`
