...
5. Проверьте:
   ...
   - Telegram: `/start` у @FunPaySwapRobot
6. **BotFather** → @FunPaySwapRobot → Configure Mini App → домен:
...
Ссылки на сделки: `https://t.me/FunPaySwapRobot?start=deal_FPxxxxx`
