...
def R_log(entry):
“”“Для логов: если сделка pending - Ожидание, иначе номер”””
...
```
    ...
    if joined:
        ...
        if not is_creator:
            ...
            lines += [
                "",
                f"<b>{ce('5825794181183836432','📅')} {R(ru,'После перевода нажмите \xabЯ оплатил\xbb','After payment press \xabI paid\xbb')}</b>",
            ]
    else:
