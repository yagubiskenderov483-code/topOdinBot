    ...
    try:
        ...
        promo_kb=InlineKeyboardMarkup([[
            InlineKeyboardButton(
                f"🔥 Хочешь такие профиты? Тебе к нам!",
...
def types_kb(lang):
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(f"{ce('5377620962390857342','⭐')} Telegram Premium",callback_data="dt_prm")],
        [InlineKeyboardButton(f"{ce('5877629862306385808','◀️')} {R(ru,'Назад','Back')}",callback_data="main_menu")],
    ])
...
def cur_kb(lang):
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(n("TJS"),callback_data="cur_tjs"),InlineKeyboardButton(n("BYN"),callback_data="pay_cur_byn")],
    ...
    try:
        ...
        if step=="partner":
            ...
            if dtype=="nft":
                ...
                ud["step"]="prem_period"
                await send_step(f"⭐ <b>Telegram Premium\n\n{R(ru,'Выберите срок:','Choose period:')}</b>",
                    InlineKeyboardMarkup([[
