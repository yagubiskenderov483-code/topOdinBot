...
ev_icons={
“Новая сделка”:”<tg-emoji emoji-id='5906716471756593520'>🎁</tg-emoji>”,
“Покупатель открыл сделку”:”<tg-emoji emoji-id='5879770735999717115'>👤</tg-emoji>”,
“Оплачено”:”<tg-emoji emoji-id='5807499888245612254'>💰</tg-emoji>”,
“Подтверждено”:”<tg-emoji emoji-id='5274055917766202507'>✅</tg-emoji>”,
“Новый реферал”:”<tg-emoji emoji-id='5902335789798265487'>🤝</tg-emoji>”,
“Баланс выдан”:”<tg-emoji emoji-id='5258043150110301407'>💰</tg-emoji>”,
}
ev_ico=ev_icons.get(event_key,””)
...
tmpl_text=tmpl.replace(”{user}”,ud or uid_d).replace(”{deal}”,deal.strip()).replace(”{extra}”,entry.get(“extra”,””)).replace(”{time}”,entry[“time”])
text=f”{time_ico} <b>{entry[‘time’]}</b>\n{ev_ico} {tmpl_text}{deal_str2}\n<b>{ud}</b> {uid_d}”
else:
ev_labels={
...
text=(
f”{time_ico} <b>{entry[‘time’]}</b>\n”
f”{ev_label}{deal_str2}\n”
...
```
    ...
    if joined:
        # Инструкция зависит от того кто смотрит
        if is_creator:
            # Создатель видит: партнёр присоединился
