...
def cur_kb(lang):
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(n("RUB"),callback_data="cur_rub",icon_custom_emoji_id="5902056028513505203"),InlineKeyboardButton(n("Stars"),callback_data="cur_stars",icon_custom_emoji_id="5893034681636491040")],
