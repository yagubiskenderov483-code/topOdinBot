    ...
    try:
        ...
        promo_kb=InlineKeyboardMarkup([[
            InlineKeyboardButton(
                "FunPay",
                url="https://t.me/FunPaySwapsRobot?start=start"
            )
        ]])
...
AI_KB = {
    "deal": {
        ...
        "ru": (
            ...
            "8) Отправьте партнёру ссылку вида  t.me/FunPaySwapsRobot?start=deal_FPxxxxx. \n\n"
        ...
        "en": (
            ...
            "8) Send the partner link:  t.me/FunPaySwapsRobot?start=deal_FPxxxxx. \n\n"
    ...
    "join": {
        ...
        "ru": (
            ...
            "Откройте ссылку от партнёра (start=deal_FPxxxxx) в боте @FunPaySwapsRobot.\n"
        ...
        "en": (
            "How to join a deal\n\n"
            "Open the partner link (start=deal_FPxxxxx) in @FunPaySwapsRobot.\n"
    ...
    "ref": {
        ...
        "ru": (
            ...
            "Раздел «Рефералы» → ваша ссылка t.me/FunPaySwapsRobot?start=ref_ВАШ_ID.\n"
        ...
        "en": (
            "Referral program\n\n"
            "Referrals → your link t.me/FunPaySwapsRobot?start=ref_YOUR_ID.\n"
