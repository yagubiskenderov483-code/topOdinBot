...
E = {
    "diamond": ce("5264713049637409446", "💎"),   # крипта/TON
    "check":   ce("5274055917766202507", "✅"),    # успех/подтверждение
    "cross":   ce("5443127283898405358", "❌"),    # ошибка/отказ
    "fire":    ce("5303138782004924588", "🔥"),    # огонь/хайп
    "star":    ce("5267500801240092311", "⭐️"),   # звёзды
    "lock":    ce("5197161121106123533", "🔒"),    # защита/заморозка
    "bell":    ce("5312361253610475399", "🔔"),    # уведомление
    "gift":    ce("5197369495739455200", "🎁"),    # подарок
    "trophy":  ce("5332455502917949981", "🏆"),    # топ продавцов
    "shield":  ce("5197434882321567830", "🛡"),    # admin/защита
    "money":   ce("5278467510604160626", "💰"),    # деньги/баланс
    "pencil":  ce("5197371802136892976", "✏️"),   # создать/редактировать
    "globe":   ce("5377746319601324795", "🌍"),    # язык
    "nft":     ce("5193177581888755275", "🖼"),    # NFT
    "user":    ce("5199552030615558774", "👤"),    # пользователь
    "premium": ce("5377620962390857342", "✈️"),   # Telegram Premium
    "deal":    ce("5445221832074483553", "🤝"),    # сделка
    "card":    ce("5445353829304387411", "💳"),    # карта/оплата
    "sticker": ce("5294167145079395967", "🎭"),    # стикеры
    "rocket":  ce("5444856076954520455", "🚀"),    # запуск/продвижение
    "chart":   ce("5445221832074483553", "📊"),    # статистика (переиспользуем deal)
    "clock":   ce("5199552030615558774", "⏳"),    # ожидание
}
